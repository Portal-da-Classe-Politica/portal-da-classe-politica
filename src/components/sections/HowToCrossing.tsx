        ...
        <div className="flex flex-col md:flex-row gap-4 w-full">
          <div className="  text-white">
            ...
            <Text size={'B2'} className="mt-auto pb-5 ">
              ...
              Integer gravida nulla ipsum, in convallis nisi mollis nec. Nam vulputate ipsum. Suspendisse non
              odio sit amet massa lobortis scelerisque. Integer gravida nulla ipsum.
            </Text>
