        ...
        {tabs.map((item, idx) => {
          return (
            <div
              ...
              className={`${
                currentTab === idx
                  ? `bg-orange text-white text-b1 md:text-4 font-bold rounded-t-[10px] py-4 px-8 cursor-pointer ${selectedClassName}`
                  : `text-orange text-b1 md:text-4 py-4 px-8 cursor-pointer ${unSelectedClassName}`
              }`}
            >
              {item}
            </div>
