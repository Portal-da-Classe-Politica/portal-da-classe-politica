...
function _getColorByVotes(votes: number, isMultiState: boolean): string {
  ...
  const colors = [
    'rgb(255,224,217)', // 0: 0-999
    'rgb(255,148,109)', // 1: 1.000-9.999
    'rgb(255,102,58)', // 2: 10.000-29.999
    'rgb(245,85,40)', // 3: 30.000-49.999
    'rgb(235,88,47)', // 4: 50.000-99.999
    'rgb(160,50,20)', // 5: 100.000+
    'rgb(120,30,10)', // 6: 200.000+
  ];
